...
from app.schemas.oil_price import OilPriceCreate, OilPriceResponse, OilPriceFilter, OilPriceUpdate
...
__all__ = [
    ...
    "OilPriceCreate", "OilPriceResponse", "OilPriceFilter", "OilPriceUpdate",
